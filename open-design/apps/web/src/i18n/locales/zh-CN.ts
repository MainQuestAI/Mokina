...
export const zhCN: Dict = {
  ...
  "homeHero.title": "从问题走向营销决策",
  "homeHero.titleWords": "市场分析,营销方案",
  "homeHero.subtitle": "从资料和目标出发，形成可核对的判断与行动。",
  ...
  "homeHero.placeholder": "描述市场问题、营销目标或想生成的成果…",
  ...
  "chat.startHint": "描述市场问题或营销目标，也可以直接提出交付要求：",
  ...
  "chat.composerPlaceholder": "继续讨论，或提出要生成、修改的成果…",
